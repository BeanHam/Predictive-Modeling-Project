...
Ultimately, the following variables were selected using the above methods and were fit using OLS regression. The resulting $Adj-R^{2}$ was 0.6315. All the included covariates had estimable coefficients (i.e. there were no NAs, as the resulting design matrix was full rank). \par
