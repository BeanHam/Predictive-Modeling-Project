...
ols.2 = lm(logprice ~ Shape + school_pntg 
           ...
           + Interm*Surface + Interm*lrgfont + Interm*portrait
           + Surface*still_life + Surface*lrgfont + Surface*author + Surface*subject + Surface*discauth
...
ols.2 = lm(logprice ~ Shape + school_pntg
           + dealer*finished + dealer*year + dealer*Interm + dealer*paired + dealer*artistliving
           + diff_origin*subject + diff_origin*portrait + diff_origin*authorstyle + diff_origin*still_life
           + artistliving*year + artistliving*endbuyer + artistliving*finished
...
```{r}
ols.2 = lm(logprice ~ Shape + school_pntg + diff_origin*Surface + Surface*lrgfont + Surface*still_life + Surface*discauth + dealer*Interm + dealer*paired + dealer*finished + diff_origin*portrait + artistliving*endbuyer + Interm*lrgfont + prevcoll*finished + paired*lrgfont + paired*discauth + diff_origin*authorstyle + diff_origin*still_life + finished*discauth + lrgfont*discauth + artistliving*finished + Interm*portrait + dealer*artistliving + authorstyle*prevcoll, data = paintings_train_2)
