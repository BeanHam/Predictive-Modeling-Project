...
test = lm(logprice ~ year*Shape + year*school_pntg + year*author + year*subject + year*dealer + year*Interm + year*Surface + year*paired + year*finished + year*diff_origin + year*portrait + year*artistliving + year*endbuyer + year*lrgfont + year*still_life + year*discauth + year*prevcoll + year*authorstyle, data = paintings_train_2)
summary(test)
```
