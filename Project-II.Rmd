...
## second time data imputation
```{r}
paintings_train_3 = paintings_train_1 %>% 
...
micetest = mice::mice(paintings_train_3, printFlag = FALSE)
paintings_train_4 = mice::complete(micetest) %>% 
  mutate(Interm = as.factor(Interm))

### test
paintings_test_3 = paintings_test_1 %>% 
   dplyr::select(logprice,
                 dealer,
                 school_pntg,
                 diff_origin,
...
micetest = mice::mice(paintings_test_3, printFlag = FALSE)
paintings_test_4 = mice::complete(micetest) %>% 
  mutate(Interm = as.factor(Interm))
