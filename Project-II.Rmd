...
ols.2 = lm(logprice ~ Shape + school_pntg
           ...
           + diff_origin*subject + diff_origin*Surface + diff_origin*portrait + diff_origin*authorstyle + diff_origin*still_life + diff_origin*prevcoll
           + artistliving*year + artistliving*endbuyer + artistliving*finished
           + Interm*lrgfont + Interm*portrait
           + Surface*subject
           + prevcoll*finished + prevcoll*engraved + prevcoll*authorstyle
...
```{r}
ols.2 = lm(logprice ~ Shape + school_pntg + prevcoll + dealer*Interm + dealer*paired + dealer*finished + diff_origin*portrait + artistliving*endbuyer + Interm*lrgfont + Surface*still_life + paired*lrgfont + paired*discauth + diff_origin*authorstyle + diff_origin*still_life + finished*discauth + lrgfont*discauth + artistliving*finished + Interm*portrait + dealer*artistliving, data = paintings_train_2)
