...
ols.2 = lm(logprice ~ Shape + school_pntg 
           ...
           + Surface*still_life + Surface*lrgfont + Surface*year + Surface*author + Surface*subject + Surface*discauth
           + prevcoll*finished + prevcoll*authorstyle
           + paired*lrgfont + paired*discauth + paired*year + paired*author + paired*subject
           + finished*discauth
           + lrgfont*discauth
           + discauth*year
           + year*subject, 
