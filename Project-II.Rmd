...
```{r}
subject = paintings_train$subject %>% 
   str_replace(., "\\([0-9]+\\)", "") %>% 
   str_trim(.) %>% 
   as.data.frame(.)
...
## Arch/Architecture/Architectures/interieur/L'interieur
## fight: bataille/Bataille/Combat/
## buste/Buste
## People: cavaliers/Cavalier/Enfant/femme/hommes/cavalerie/famille/fille/Joseph/Joueurs/L'Enfant/L'enfant/
##            Naissance/Mariage/Dame/Marchande
## flower& fruits: feuille(flower)/fleurs/fruits/
## holy: JC/Jesus Christ/Jesus-Christ/Assomption/vierge/Vierge/martyre/N.S./North(-)Seigneur/NS/Officier
## love: Adoration/L'Adoration/Amour/L'Amous/L'amour
## Marine/marines
```
