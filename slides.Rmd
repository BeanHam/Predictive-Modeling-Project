...
barplot(coef_table[2:11,2], names.arg = coef_table[2:11,1], cex.names = 0.8, horiz = TRUE, las = 1)


#ggplot2::ggplot(data = coef_table, mapping = ggplot2::aes(x = coef, label = names)) + ggplot2::geom_bar()
