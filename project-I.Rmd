...
train_df = dplyr::data_frame(
  ...
  position = paintings_train$position %>% as.numeric(),
  dealer = paintings_train$dealer %>% as.factor(),
  year = paintings_train$year %>% as.integer(),
  origin_author = paintings_train$origin_author %>% as.factor(),
  origin_cat = paintings_train$origin_cat %>% as.factor(),
  school_pntg = paintings_train$school_pntg %>% as.factor(),
  diff_origin = paintings_train$diff_origin %>% as.factor(),
  logprice = paintings_train$logprice %>% as.numeric(),
  price = stringr::str_remove_all(paintings_train$price, ",") %>% as.numeric(),
  artistliving = paintings_train$artistliving %>% as.factor(),
  authorstyle = 
)
