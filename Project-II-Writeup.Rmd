...
The final model that is specified has generally good performance and characteristics. There are three outliers in the residuals versus fitted values plot, though the plot otherwise appears to indicate that the model meets the homoskedasticity assumption,  
- magnitude of coefficients and standard errors
- avPlots - not very helpful because so many categorical/indicdator variables

There are three points with Cook's distance of 1 (points 423, 1129, 1351). It is unclear if they are influential at this time. 
