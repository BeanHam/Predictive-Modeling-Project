...
kable(top_10 %>% arrange(desc(price)) %>% slice(1:10), digits = 1, align = "c")
```
...
compare_stats = data.frame(
  In_Samp_Multiple_R2 = c(0.63, 0.6901),
  In_Samp_Adjested_R2 = c(0.6129, 0.6634),
  RMSE = c(1502.99, 1219.52),
  Coverage = c(0.9506667, 0.9587)
)
rownames(compare_stats) = c("Part 1 model", "Part 2 model")
kable(compare_stats)
```
