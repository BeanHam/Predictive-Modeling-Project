...
plot(bma1, which=4)
BPM1 = predict(bma, estimator = "BPM")
variable.names(BPM1)
...
ols = lm(logprice ~ (dealer + school_pntg + diff_origin + artistliving + endbuyer + authorstyle + 
                       ...
                       finished + lrgfont + portrait + discauth + still_life + materialCat)^2, 
         data = paintings_train_2)
plot(ols)
```
...
```{r}
ols.2 = lm(logprice ~ dealer*artistliving + dealer*Interm + dealer*Surface + dealer*paired + dealer*finished + dealer*discauth + diff_origin*Surface + diff_origin*portrait + artistliving*endbuyer + artistliving*authorstyle + Interm*Surface + Interm*Surface + Surface*lrgfont + Surface*still_life + Surface*discauth + prevcoll*finished + paired*lrgfont + paired*discauth + diff_origin*authorstyle + diff_origin*still_life + finished*discauth + lrgfont*discauth, data = paintings_train_2)
