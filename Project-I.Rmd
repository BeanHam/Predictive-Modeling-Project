...
```{r, eval=FALSE}
paintings_train_1 <- paintings_train %>% 
  select(logprice, origin_author, dealer, origin_cat, authorstyle, Interm, type_intermed,
         nfigures, engraved, original)

paintings_train_1 <- paintings_train %>% 
  select(logprice, prevcoll, othartist, figures, relig, landsALL, lands_sc, lands_elem,
         lands_figs, lands_ment, arch, mytho, peasant, othgenre, singlefig, portrait,
         still_life, discauth, history, allegory, pastorale)
```
